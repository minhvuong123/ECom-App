      ...
      <Container >
        <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
            ...
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
              ...
              <p className="mb-2">At our electronics store, we are dedicated to providing the lastest and greatest devices and accessories to our customers. With a wide selection of phones, TVs, laptops, wathces, and accessories.</p>
              <p>&copy; {new Date().getFullYear()}, ECom-shop. All rights reserved</p>
            </div>
            <FooterList>
